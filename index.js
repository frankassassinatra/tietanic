...
function injectWow() {
  ...
  if (wows === 10) {
    lengthEl.innerText = "nICE"
  }

  if (wows === 50) {
    lengthEl.innerText = "kind of nICE"
  }

  if (wows === 100) {
    lengthEl.innerText = "really nICE"
  }

  if (wows === 150) {
    lengthEl.innerText = "so so nICE"
  }

  if (wows === 250) {
    lengthEl.innerText = "absolutely nICE"
  }

  if (wows === 500) {
    lengthEl.innerText = "enormously nICE"
  }

  if (wows === 1000) {
    lengthEl.innerText = "freaking nICEEE!"
  }

  if (wows === 2000) {
    lengthEl.innerText = "nICEST thing I ever seen"
  }

  if (wows === 3000) {
    lengthEl.innerText = "brutally nICE"
  }
